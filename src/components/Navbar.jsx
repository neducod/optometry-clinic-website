...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-[#f8f9f5] border-b border-gray-200/60 px-6 py-4 flex items-center justify-between font-mono text-sm">
      {/* Logo */}
      <div className="flex items-center gap-2">
        {/* Simple stylized SVG logo matching 'teak' icon */}
      ...
      {/* Navigation Links with Colored Squares */}
      <div className="hidden md:flex items-center gap-6 bg-white/70 px-5 py-2.5 rounded-sm shadow-xs border border-gray-100/80">
        {navItems.map((item) => (
          <a
            key={item.name}
